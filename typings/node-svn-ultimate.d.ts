// Typings based on https://github.com/peteward44/node-svn-ultimate
declare module "node-svn-ultimate" {
    ...
    export namespace commands {
         ...
         */
        export function checkout(branchUrl: string, destination: string, options: OptionsParams, callback: (error: Error) => void): void;
         ...
         * @param callback - Complete callback
         */
        export function status(workingCopy: string, options: OptionsParams, callback: (error: Error, data: any) => void): void;
         ...
         * @param callback - Complete callback
         */
        export function commit(files: string|string[], options: OptionsParams, callback: (error: Error) => void): void;
         ...
         * @param callback - Complete callback
         */
        export function copy(source: string|string[], destination: string, options: OptionsParams, callback: (error: Error) => void): void;
    }
